...
#define PLUGIN "[MG][ZI] Gamemode Normal"
#define VERSION "1.0.0"
#define AUTHOR "Vieni"

new const gGamemodeId = ZI_GAMEMODE_NORMAL
new const gGamemodeName[] = "ZI_NGAMEMODE_NORMAL"
...
public plugin_init()
{
    ...
    zi_core_gamemode_reg(gGamemodeId, gGamemodeName, ZI_GMTYPE_NORMAL, true, true, true, false)
}
