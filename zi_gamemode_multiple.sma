...
#define PLUGIN "[MG][ZI] Gamemode Multiple"
#define VERSION "1.0.0"
#define AUTHOR "Vieni"

new const gGamemodeId = ZI_GAMEMODE_MULTIPLE
new const gGamemodeName[] = "ZI_NGAMEMODE_MULTIPLE"
...
public plugin_init()
{
    ...
    zi_core_gamemode_reg(gGamemodeId, gGamemodeName, ZI_GMTYPE_MULTIPLE, true, true, true, false)
}
